...
static const struct {
	...
	{ PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_CORE_7TH_GEN_D,
	  "7th generation (Kaby Lake family) Core Processor (Desktop Dual Core)" },
	{ PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_CORE_7TH_GEN_D_Q,
	  "7th generation (Kaby Lake family) Core Processor (Desktop Quad Core)" },
